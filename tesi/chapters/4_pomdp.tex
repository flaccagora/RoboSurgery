...
% Zhang  Lee, 1998).
\todo{correggi ultima parte exact value iteration}
\emph{An alternative approach builds on Sondik's idea of computing a useful linear function for a
...
\todo{correggi ultima parte perseus}
